...
function StaffList(props) {
  ...
  useEffect(() => {
    fetch('https://tim-acs.herokuapp.com/admin/get-all-staff').then(res => {
      res.json().then(data => {
        console.log('++++++++', data);
      ...
      <ScrollView style={styles.main}>
        {allStaff.length > 0 &&
          allStaff.map((staf, ind) => {
            if (
              staf.username == appProps.staff.username ||
              staf.username.includes('ACS/ADMIN')
            ) {
              return null;
            } else {
              const imageUrl =
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.individual}>
                    ...
                    <View style={styles.mainDet}>
                      ...
                      <View>
                        <Text appearance="hint">{staf.username}</Text>
                      </View>
                    </View>
                  </View>
                </TouchableOpacity>
